...
1. Place your `.pdf` (PedalPCB) or `.csv` BOM files into that folder.
1. Run the script:

   ```bash
   python tools/generate_presets.py

1. The script will parse all files, flatten them into standard text format, and overwrite `src/presets.py`.
